...
def _cls_2_1(
    ...
    if c1 == "high" and r1 == "1":
        return (
            "Confident & Correct",
            "Model knew what it was doing - ideal case.",
            1.0,
        )
    if c1 == "high" and r1 == "0":
        return (
            "Confidently Wrong",
            "Most dangerous failure mode - fluent but incorrect.",
            0.1,
        )
    if c1 == "low" and r1 == "1":
        return (
            "Lucky or Cautious",
            "Model was uncertain but arrived at the right answer.",
            0.6,
        )
    return (
        "Uncertain & Wrong",
        "Model was unsure and got it wrong - expected, less concerning.",
        0.2,
    )
...
def _cls_2_12(
    ...
    if tlm == "low" and r1 == "0":
        return (
            "Critical Token Derailed Answer",
            "A single uncertain token decision may have derailed the answer.",
            0.1,
        )
    if tlm == "low" and r1 == "1":
        return (
            "Risky Token Bet Paid Off",
            "Model took a risky token bet and it paid off.",
            0.6,
        )
    if tlm == "high" and r1 == "1":
        return (
            "Smooth Correct",
            "No extreme token uncertainty, correct answer - clean generation.",
            0.9,
        )
    return (
        "Smooth but Wrong",
        "No extreme token surprise yet wrong - the error isn't from a single uncertain moment.",
        0.3,
    )
...
def _cls_2_5(
    ...
    if r2 == "0" and r1 == "1":
        return (
            "Correct but Unformatted",
            "Right answer buried in unstructured output - extraction risk.",
            0.6,
        )
...
def _cls_3_18(
    ...
    if p3 == "low" and c3 == "high" and r1 == "1":
        return (
            "Insightful Compression",
            "High-surprisal prompt, brief confident completion, correct.",
            1.0,
        )
    if p3 == "high" and c3 == "low" and r1 == "1":
        return (
            "Appropriate Expansion",
            "Familiar prompt, extended or uncertain completion, correct.",
            0.8,
        )
    if p3 == "low" and c3 == "low" and r1 == "0":
        return (
            "Complex Problem, Wasted Effort",
            "High-surprisal prompt, extended uncertain completion, wrong.",
            0.1,
        )
    if p3 == "high" and c3 == "high" and r1 == "1":
        return (
            "Proportional IO",
            "Familiar prompt, brief confident completion, correct.",
            0.8,
        )
    if p3 == "high" and c3 == "high" and r1 == "0":
        return (
            "Simple Problem, Brief Failure",
            "Familiar prompt, brief confident completion, wrong.",
            0.2,
        )
    return (
        "Mixed IO Profile",
